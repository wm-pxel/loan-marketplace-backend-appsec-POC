...
public class AwsCognitoException extends RuntimeException implements GraphQLError {
    public AwsCognitoException() { super(); }

    public AwsCognitoException(String message) { super(message); }

    public AwsCognitoException(String message, Throwable cause) {
        super(message, cause);
    }

    public AwsCognitoException(Throwable cause) {
        super(cause);
    }
