...
public class ActivityCreationException extends RuntimeException implements GraphQLError {
    ...
    public ActivityCreationException(String message, Throwable cause) {
        super(message, cause);
    }
