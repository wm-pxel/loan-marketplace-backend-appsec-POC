...
import static com.westmonroe.loansyndication.utils.EmailTypeEnum.SIGNED_PC_SENT;

public class SignedParticipationCertificateSentEmailInfo implements EmailInfo {
    private final DealMemberDao dealMemberDao;
    private final Map<String, Object> templateDataMap;

    public SignedParticipationCertificateSentEmailInfo(DealMemberDao dealMemberDao, Map<String, Object> templateDataMap) {
    ...
    public String getTemplateName() {
        return SIGNED_PC_SENT.getTemplateName();
    }
